...
<p float="left">
  <img src="./genome_wide_t-test_project/ttest_imgs/ttest_dist.png" width="400">
  <img src="./genome_wide_t-test_project/ttest_imgs/ttest_dist2.png" width="400">
</p>

#### - Top 20 Discriminant Genes from both Sequential and MPI Parallel Programs:

<p float="left">
  <img src="./genome_wide_t-test_project/ttest_imgs/topgenes_seq.png" width="400">
  <img src="./genome_wide_t-test_project/ttest_imgs/topgenes_mpi.png" width="400">
</p>

#### - Open MPI Speed Up (~100X):

<p float="left">
  <img src="./genome_wide_t-test_project/ttest_imgs/ttest_speedup.png" width="400">
</p>
